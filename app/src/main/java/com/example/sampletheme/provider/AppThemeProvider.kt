...
import com.example.sampletheme.R
import com.example.sampletheme.utility.getPrefs
...
class AppThemeProvider constructor(private val context: Context) : ThemeProvider {
    ...
    private val ThemeProvider.Theme.storageKey: String
        get() = when (this) {
            ...
            ThemeProvider.Theme.PINK -> context.getString(R.string.pref_theme_pink_value)
        }
    ...
    private fun getThemeForStorageValue(value: String) = when (value) {
        ...
        context.getString(R.string.pref_theme_pink_value) -> ThemeProvider.Theme.PINK
        else -> ThemeProvider.Theme.SYSTEM
    }

    override fun setThemeMode(value: ThemeProvider.Theme) {
        theme = value
    }
}